...
export const EditPage = () => {
  ...
  return (
    <div className='w-full font-Quicksand flex items-center justify-center flex-col'>
        <div className='shadow-2xl flex items-center justify-center flex-col bg-white mt-[5%] w-4/12 p-3 rounded-md shadow-white'>
            ...
            <input value={edit.name} onChange={(e) => setEdit(e.target.value)} type="text" placeholder='e.g. wash dishes' className='my-3 p-2 w-11/12 border-solid border-green-800 border-[1px] bg-black/10 rounded-sm outline-none mr-3' />
        ...
        {res && <Alert severity="success" className='absolute top-10 w-3/12 right-10 text-center flex items-center justify-center'>{res}</Alert>}
    </div>
  )
}
